  ...
  Element.prototype.prepend = function (element) {
    this.insertBefore(
      element instanceof Node
        ? element
        : document.createTextNode(String(element)),
      this.firstChild
    );
  };
}
...
function showModal(sMessage, sError) {
  ...
  bModalOpened = true;
  defocus();
  getEl("modal_content").innerHTML =
    sMessage +
    '<br><br><span class="small">' +
    getLang("hide-modal-hint") +
    "</span>";
...
function getUniqueId() {
  ...
  sDeviceUid =
    sDeviceFamily +
    "|" +
    btoa([navigator.userAgent, new Date().getTime()].join("|")).replace(
      /=/g,
      "1"
    );
  ...
  try {
    switch (sDeviceFamily) {
      ...
      case "Android":
        ...
        var sButtons =
          '<div id="confirm_buttons"><span id="confirm_yes" onclick="closeApp()">' +
          getLang("yes") +
          '</span> <span id="confirm_no" onclick="closeConfirm()">' +
          getLang("no") +
          "</span></div>";
        ...
        oConfirmbox.innerHTML =
          '<div id="custom_confirm_content" class="fullscreen-popup">' +
          sText +
          sButtons +
          "</div>";
        bYesConfirmSelected = false;
  ...
  switch (sTheme) {
    case "Dark":
      oCustomTheme.innerText =
        ":root { --theme-light: #ddd; --theme-moderate: #888; --theme-dark: #171717; --bg-moderate: #181818; }";
      break;
    case "Orange":
      oCustomTheme.innerText =
        ":root { --theme-light: #ffb26d; --theme-moderate: #ff7e00; --theme-dark: #52300e; --bg-moderate: #312b28; }";
      break;
    case "Green":
      oCustomTheme.innerText =
        ":root { --theme-light: #61ff5d; --theme-moderate: #2d7900; --theme-dark: #112b13; --bg-moderate: #293128; }";
      break;
    case "Lime":
      oCustomTheme.innerText =
        ":root { --theme-light: #9bcf9b; --theme-moderate: #00b300; --theme-dark: #005700; --bg-moderate: #223122; }";
      break;
    case "Blue":
      oCustomTheme.innerText =
        ":root { --theme-light: #ddd; --theme-moderate: #0059b7; --theme-dark: #11112b; --bg-moderate: #232231; }";
      break;
    case "Red":
      oCustomTheme.innerText =
        ":root { --theme-light: #ff7c7c; --theme-moderate: #c10000; --theme-dark: #2d1212; --bg-moderate: #312626; }";
      break;
    case "Magenta":
      oCustomTheme.innerText =
        ":root { --theme-light: #ff97d5; --theme-moderate: #fe089a; --theme-dark: #290319; --bg-moderate: #271f23; }";
      break;
    case "Purple":
      oCustomTheme.innerText =
        ":root { --theme-light: #db99ff; --theme-moderate: #890ccb; --theme-dark: #200a2d; --bg-moderate: #29212d; }";
      break;
    default:
      oCustomTheme.innerText = "";
  }
